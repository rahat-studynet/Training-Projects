"""
Main URL configuration for the agent_system project.

This file handles:
- Django admin panel
- Accounts pages
- Admin product CMS
- Regular user product/cart/checkout pages
- DRF cart API
- Media file serving during development
- Invalid URL fallback response
"""
...
# Custom fallback response for invalid URLs
...
urlpatterns = [
    ...
    # Accounts app: home, signup, signin, logout
    ...
    # Regular user product and cart routes
...
# Invalid URL handler must stay at the very bottom
urlpatterns += [
